...
The function statistics.raplot calculates the reclassification metrics.
Used by CI.raplot.
...
- t:
  ...
  scenario with a threshold of 0.1 & t\<-c(0,0.1,0.3,1) is a three group
  scenario with thresholds at 0.1 and 0.3. Nb. If no t is provided it
  defaults to a single threshold at the prevalence of the cohort.
